...
void plan_buffer_line(const float &x, const float &y, const float &z, const float &e, float feed_rate, const uint8_t &extruder)
{
  ...
  long target[4];
  target[X_AXIS] = lround(x*axis_steps_per_unit[X_AXIS]);// lround agit comme abs. Elle donne la valeur du nombre intégrale le plus proche.
