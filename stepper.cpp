...
static bool old_e_min_endstop2=false;
  ...
  if (current_block != NULL) 
		  {
			...
			/*  #if PRIVATE_ENDSTOPS1 > -1
				  ...
				  bool e_min_endstop=(READ(PRIVATE_ENDSTOPS1) != E_ENDSTOPS_INVERTING);
				  if((!e_min_endstop) && (!old_e_min_endstop) && (current_block->steps_e > 0)&&(active_extruder==0)&&(unloading_command==false)) {
					endstops_trigsteps[E_AXIS] = count_position[E_AXIS];
					endstop_e_hit=true;
					step_events_completed = current_block->step_event_count;	
				  ...
				  bool e_min_endstop2=(READ(PRIVATE_ENDSTOPS2) != E_ENDSTOPS_INVERTING);
				  if((!e_min_endstop2) && (!old_e_min_endstop2) && (current_block->steps_e > 0)&&(active_extruder==1)&&(unloading_command==false)) {
					endstops_trigsteps[E_AXIS] = count_position[E_AXIS];
					endstop_e_hit=true;
					step_events_completed = current_block->step_event_count;
